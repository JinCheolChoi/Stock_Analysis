...
#
#*******************
Models_Env$Simple_BBands=c()
Models_Env$Simple_BBands$Essential_Indicators=c("BBands") # list of required indicators
Models_Env$Simple_BBands$Function=function(BBands_Data,
                                           Long_Consec_Times=1,
...
#
#*******************
Models_Env$Simple_RSI=c()
Models_Env$Simple_RSI$Essential_Indicators=c("BBands") # list of required indicators
Models_Env$Simple_RSI$Function=function(BBands_Data,
                                        Long_Consec_Times=1,
                                        Short_Consec_Times=1,
                                        Long_PctB=0,
                                        Short_PctB=1){
...
#
#*****************
Models_Env$Simple_Test=c()
Models_Env$Simple_Test$Essential_Indicators=c("BBands", "RSI") # list of required indicators
Models_Env$Simple_Test$Function=function(Data,
                                         x=1,
                                         y=1){
  if(nrow(Data)>50){
    output=c(T, F)
